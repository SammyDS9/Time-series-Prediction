# Time-series-Prediction: Built a Time series model to predict Readmision of patients in Hospital. For HIPPA issues i have used a randomly generated data set.
